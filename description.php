			...
			<div class="col-md-6">
				...
				<div class="mt-3 mb-5" id="button-container">
					...
					if($num_rows2 == 0){
						...
						echo '<button class="btn bg-primary btn-lg text-white" id="add-cart">Added to Cart</button>';
					}

					if($num_rows == 0){
						echo '<button style="margin-left: 5px" class="btn btn-warning btn-lg" id="wishlist-btn">Wishlist</button>';
					}else{
						echo '<button style="margin-left: 5px" class="btn btn-success btn-lg" id="unwishlist-btn">Wishlisted</button>';
					}
					?>
	...
	<div class="row">
		...
		<div class="col-md-5">
			...
			<form class="mb-5" action="submit_review.php" method="POST">
				...
				<input class="btn btn-warning" type="submit" name="" value="Submit Review">
			</form>
		</div>
	</div>
</div>